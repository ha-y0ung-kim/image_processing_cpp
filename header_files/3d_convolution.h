...
vector3d convolution3d(const vector3d &image, const vector2dd &kernel, bool addpix)
{
    /*
    ...
    */
    ...
    for (int k = 0; k < num_channel; k++)
    {
        for (int i = 0; i < height; i++)
        {
            ...
            {
                padded_image[k][i + kernel_half][j + kernel_half] = image[k][i][j];
            }
        }
    }
